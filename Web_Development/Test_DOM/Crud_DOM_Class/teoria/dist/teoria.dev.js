...
console.log('getElementsByTagName', document.getElementsByTagName('h1')); //* getElementById selecciona el Nodo de nuestro HTML por id

console.log('getElementById', document.getElementById('alumnoDelMes')); //* getElementsByClassName traer TODOS los elementos que tengan la clase aprobado

console.log('getElementsByClassName', document.getElementsByClassName('aprobado')); //* querySelector selecciono UN único elemento por la condición que le indique (primero)
...
console.log('querySelector por clase', document.querySelector('p.aprobado > span.nota')); //* querySelector selecciono UN único elemento por la condición que le indique (primero)
...
console.log('querySelectorAll por clase', document.querySelectorAll('p.aprobado > span.nota')); //? UPDATE
// para actualizar no hay 5 métodos o 10 métodos
// voy a poder actualizar todo tipo de cosas en mis elementos de HTML
// READ

var allMyAlumns = document.querySelectorAll('p'); // array
...
try {
  for (var _iterator = allMyAlumns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var alumn = _step.value;
