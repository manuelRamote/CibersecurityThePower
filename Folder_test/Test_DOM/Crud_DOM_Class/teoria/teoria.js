...
console.log(
  ...
  document.getElementsByClassName('aprobado')
)
...
console.log(
  ...
  document.querySelector('p.aprobado > span.nota')
)

//* querySelector selecciono UN único elemento por la condición que le indique (primero)
console.log('querySelectorAll por etiqueta', document.querySelectorAll('h1'))
console.log(
  'querySelectorAll por id',
  document.querySelectorAll('#alumnoDelMes')
)
console.log(
  'querySelectorAll por clase',
  document.querySelectorAll('.aprobado')
)
console.log(
  'querySelectorAll por clase',
  document.querySelectorAll('p.aprobado')
)
console.log(
  'querySelectorAll por clase',
  document.querySelectorAll('p.aprobado > span.nota')
)
