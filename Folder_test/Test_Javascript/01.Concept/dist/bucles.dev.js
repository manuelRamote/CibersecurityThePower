...
var frutas = ['pomelo', 'pera', 'manzana', 'naranja', 'mandarina']; // sin bucles...
...
for (var _i = 0; _i < frutas.length; _i++) {
  console.log(frutas[_i]); // pomelo // pera // manzana // naranja // mandarina
} //bucles anidados
...
for (var _i2 = 0; _i2 < frutas.length; _i2++) {
  var fruta = frutas[_i2];
  console.log('La fruta i es: ' + frutas[_i2]);
